...
@testset "without_kit go local" begin
    ...
    _with_tempdir() do tmp
        ...
        @test read(joinpath(file_batch, "masterhost", "pi_results.txt"), String) == solo_body
        ...
        a = read(joinpath(pipe_batch, "masterhost-1", "pi_results.txt"), String)
        b = read(joinpath(pipe_batch, "masterhost-2", "pi_results.txt"), String)
        @test occursin("pi=", a)
        @test a == b
    end
end
