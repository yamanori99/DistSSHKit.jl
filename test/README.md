...
| **ssh-e2e macOS** (`E2E / macOS → Linux - schedule`) | Same suite from **macOS Intel** + Colima. Daily 06:00 JST (`workflow_dispatch` in the title when run manually). Pulls the worker image the Linux job pushed | ~25–50 min |
