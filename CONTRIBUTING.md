...
- SSH work: Git, OpenSSH, rsync. Match **major.minor** with remotes (CI E2E workers are 1.12). Merge-only SSH E2E: `E2E / macOS → Linux (skipped on PR)`, `E2E / WSL2 → Linux (skipped on PR)`
