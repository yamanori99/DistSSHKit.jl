...
- SSH work: Git, OpenSSH, rsync. Match **major.minor** with remotes (CI E2E workers are 1.12). Daily / dispatch SSH E2E: `E2E / macOS → Linux (schedule / dispatch)`, `E2E / WSL2 → Linux (schedule / dispatch)`
