...
#
#   julia --project=. -m DistSSHKit drive masterhost:4 demos/with_kit/square_file.jl
#   julia --project=. -m DistSSHKit drive masterhost:4 demos/with_kit/square_file.jl 4
