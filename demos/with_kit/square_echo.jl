...
#
#   julia --project=. -m DistSSHKit drive parent:2 distsshkit_demos/with_kit/square_echo.jl
#   julia --project=. -m DistSSHKit drive parent:2 distsshkit_demos/with_kit/square_echo.jl --n 4
